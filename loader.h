...
#define ASCII_CASE_MASK 0x0020002000200020ULL // UTF-16 ASCII case bit mask
...
/* Uppercase four UTF-16 ASCII hex characters
   using a single bit mask */
#define ASCII_TOUPPER64(x) \
    ((x) & ~ASCII_CASE_MASK)
